...
export default function HomePage() {
  ...
  const isRateLimited =
    getProducts.error?.message?.includes("status code 429") ||
    getBeans.error?.message?.includes("status code 429") ||
    getForms.error?.message?.includes("status code 429");
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      {isRateLimited ? (
        ...
        >
          Too many requests — you’ve reached the rate limit. Please wait a few
              ...
              >
                ...
                <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
                  ...
                  <Button
                    ...
                    size="small"
                    disabled={
                      !getProducts.data || getProducts.data.length < limit
                    }
                    onClick={() => handlePageChange(page + 1)}
                    sx={{
                      textTransform: "none",
